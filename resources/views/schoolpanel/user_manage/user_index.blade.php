...
@section('content')
  ...
  <section class="content-header" style="margin-right: 1%;height: 50px">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="font-size: 25px;font-weight: bolder;margin-left: -15px">Created User List</h3>
          </div>
          <div class="col-sm-6">
...
<div class="card"  style="margin-right:1%">
   <div class="card-header">
        ...
        &nbsp;&nbsp;&nbsp;
         <a href="{{ route('userList')}}" id="" class="btn medium hover-purple bg-red">
  ...
  <div class="modal fade" id="Create" data-backdrop="static" >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="border-bottom: 4px solid #ee1b22;min-height: 350px">
          ...
          <div class="col-md-12">
              <form method="POST" action="{{ route('storeCreateUserInfo') }}">
