        ...
        <div class="content-wrapper">
            <div id="page-content" style="margin-top: 20px;margin-left: 20px">
                ...
                <div id="page-content" style="margin-top: 20px;margin-left: 20px">
                    ...
                    <a href="{{ route('shift_info') }}" id="" class="btn medium hover-purple bg-red" role="presentation" href="" title="" data-original-title="Add New shift">
                        <i class="fa fa-eye" aria-hidden="true"></i> View All shift
                    </a>

                    <a href="{{ route('assign_shift', 'gen=trash') }}" id="" class="btn medium hover-purple bg-black" role="presentation" href="" title="" data-original-title="Add New shift">
                    ...
                    <table class="table table-hover table-condensed table-striped table-bordered table-active">
                        ...
                        foreach ($myshifts as $key => $value) {
                            ...
                            {
                                $table_option .= "<td>
          <a href='". route('assign_shift.restore', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Restore'><i class='nav-icon fas fa-window-restore text-success'></i></a></td>";

                            }else{
                                $table_option .= "<td>
          <a href='". route('assign_shift.destroy', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Delete'><i class='nav-icon fas fa-trash text-danger'></i></a>
          </td>";
