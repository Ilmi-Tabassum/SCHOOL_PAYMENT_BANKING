    ...
    <div class="content-wrapper">
        <div id="page-content" style="margin-top: 20px;margin-left: 20px">
            ...
            <div id="page-content" style="margin-top: 20px;margin-left: 20px">
                ...
                <a href="{{ route('assign_section', 'gen=trash') }}" id="" class="btn medium hover-purple bg-black" role="presentation" href="" title="" data-original-title="Add New Section">
                ...
                <table class="table table-hover table-condensed table-striped table-bordered table-active ">
                    ...
                    foreach ($mysections as $key => $value) {
                        ...
                        {
                            $table_option .= "<td>
          <a href='". route('assign_section.restore', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Restore'><i class='nav-icon fas fa-window-restore text-success'></i></a></td>";

                        }else{
                            $table_option .= "<td>
          <a href='". route('assign_section.destroy', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Delete'><i class='nav-icon fas fa-trash text-danger'></i></a>
          </td>";
