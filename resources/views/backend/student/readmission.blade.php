   ...
   <div id="page-content" style="margin-top: 20px;margin-left: 20px">
       <section class="content-header" style="margin-right: 1%;height: 50px">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h3 style="font-size: 25px;font-weight: bolder;margin-left: -8px">ReAdmission</h3>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                <li class="breadcrumb-item active">ReAdmission</li>
              </ol>
            </div>
          </div>
        </div>
...
<!-- <div style="clear:both; height:10px;"></div> -->
  ...
  <div class="row">
    <div class="col-md-12">
       <form method="POST" action="{{ route('students.readmission_store') }}" enctype="multipart/form-data" autocomplete="off">
        @csrf
