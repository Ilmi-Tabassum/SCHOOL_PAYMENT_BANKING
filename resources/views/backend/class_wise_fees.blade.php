...
<div class="card" style="margin-right:1%;margin-left:1%;display: none" id="hideshowMe" >
        ...
        <tbody>
           ...
           <tr>
             ...
             <td style="text-align: center;">
              ...
              <input type="text" name="amount_{{$value->id}}" disabled="" id="amount{{$i}}" value="" class="given_amount"maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
  ...
  <div style="text-align: center;margin-bottom: 10px;display: none" id="hideSubmitBtn">
    <input type="submit" class="btn btn-primary" style="background-color: red;border-color: red" value="Save" disabled id="generateInvoiceBtn">
  </div>
