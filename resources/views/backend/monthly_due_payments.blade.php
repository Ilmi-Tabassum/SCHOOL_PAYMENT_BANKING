...
@section('content')
   ...
   <section class="content-header" style="margin-right: 1%;height: 50px">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="font-size: 25px;font-weight: bolder;margin-left: -15px">Monthly Due Payments</h3>
          </div>
          <div class="col-sm-6">
...
<div class="card"  style="margin-right:1%">
   ...
   <form method="POST" action="{{route('serachMonthlyDuePayments')}}">
        @csrf
        <div class="row">
           <div class="col-3">
            <div>
 ...
 <table class="table table-hover table-condensed table-striped">
  ...
  <tbody>
   ...
   @foreach($data as $d)
    ...
    <tr>
      <td>{{$i}}</td>
      <td style="text-align: center">{{$d->names}}</td>
