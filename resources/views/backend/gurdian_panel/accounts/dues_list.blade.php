...
@section('content')
   ...
   <section class="content-header" style="margin-right: 1%;height: 50px">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="font-size: 25px;font-weight: bolder;margin-left: -15px">Dues List</h3>
          </div>
          <div class="col-sm-6">
...
<div class="card"  style="margin-right:1%">
 ...
 <table class="table table-hover table-condensed table-striped" >
    <div class="card-header">
     <form method="post" action="{{route('StudentWiseDuesList')}}">
      @csrf
         <div class="row">
            ...
            <div class="col-md-8 col-sm-6">
             <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#modal-default" style="background-color:#ee1b22;border-color:#ee1b22;">
              <span style="margin-left:5px">Search Student Dues</span>
             </button>
            </div>
      ...
      @foreach($dues_list as $d)
        ...
        <tr>
          ...
          <td>{{$d->due}}</td>
            ...
            <td>
                <a href="{{ route('invoice.show',$d->invoice_no) }}" id="" class="btn medium hover-purple " role="presentation" href="" title="" >
...
<tbody>
  <tr>
    <td colspan="5" style="text-align: center;font-weight: bold;color: red">No Students Available</td>
  </tr>
</tbody>
@endif
...
<div class="d-flex">
  @if($hasData==1)
  <div class="mx-auto">
        {{$dues_list->links("pagination::bootstrap-4")}}
  </div>
  @endif
</div>
