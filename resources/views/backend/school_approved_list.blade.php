  ...
  <div id="page-content" style="margin-top: 20px;margin-left: 20px">
   ...
   <div id="page-content" style="margin-top: 20px;margin-left: 20px">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="font-size: 25px;font-weight: bolder;margin-left: -15px">Approved School List</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
              <li class="breadcrumb-item active">Approved School List</li>
            </ol>
          </div>
        </div>
      </div>
...
<div style="clear:both; height:10px;"></div>
 <table class="table table-hover table-condensed table-bordered table-sm table-striped">
  <tbody>
    <tr>
      <th>SL</th>
      <th>School Name</th>
      ...
      if(count($schools) > 0){
        foreach ($schools as $key => $value) {
          ...
          $table_option .= "<td>
                        ...
                        <a href='#' data-url='" . route('school_info.prefetch-denied', $value->id) . "'  data-title='Denied Information' data-original-title='Denied Information' style='padding-right: 10px' data-toggle='modal' data-target='#modal-custom' class='tooltip-button CallGlobalModal' title='Denied This'>
