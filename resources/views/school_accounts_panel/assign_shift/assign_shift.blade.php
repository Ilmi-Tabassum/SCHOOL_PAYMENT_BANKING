                ...
                <div id="page-content" style="margin-top: 20px;margin-left: 20px">
                    <section class="content-header" style="margin-right: 1%;height: 50px">
                        <div class="container-fluid">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h3 style="font-size: 25px;font-weight: bolder;margin-left: -8px">Assign Shift</h3>
                                </div>
                                <div class="col-sm-6">
                    ...
                    <button type="button" class="btn btn-primary CallModal" data-submit="Save"  data-title="Assign shift" data-toggle="modal" data-target="#modal-custom" data-url="{{ route('school_accounts_panel-assign_shift.create') }}" style="background-color:#ee1b22;border-color:#ee1b22 ">
                        <i class="fa fa-plus" aria-hidden="true"></i> Assign shift
                    </button>

                    <a href="{{ route('school_accounts_panel-assign_shift') }}" id="" class="btn medium hover-purple bg-red" role="presentation" href="" title="" data-original-title="Add New shift">
                        <i class="fa fa-eye" aria-hidden="true"></i> View All shift
                    </a>

                    <a href="{{ route('school_accounts_panel-assign_shift', 'gen=trash') }}" id="" class="btn medium hover-purple bg-black" role="presentation" href="" title="" data-original-title="Add New shift">
                    ...
                    <table class="table table-hover table-condensed table-striped">
                        ...
                        foreach ($myshifts as $key => $value) {
                            ...
                            {
                                $table_option .= "<td>
          <a href='". route('school_accounts_panel-assign_shift.restore', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Restore'><i class='nav-icon fas fa-window-restore text-success'></i></a></td>";

                            }else{
                                $table_option .= "<td>
          <a href='". route('school_accounts_panel-assign_shift.destroy', $value->id) ."' class='tooltip-button confirm_delete_dialog' data-original-title='Delete'><i class='nav-icon fas fa-trash text-danger'></i></a>
          </td>";
