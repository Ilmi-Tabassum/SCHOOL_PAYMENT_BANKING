    ...
    <div class="content-wrapper">
        ...
        <div id="page-content" style="margin-top: 0px;margin-left: 20px">
            ...
            <div id="page-content" style="margin-top: 0px;margin-left: 20px">
                ...
                <form method="post" action="{{route('school_accounts_panel-fees_collection.search')}}">
                    {{csrf_field()}}
                ...
                <table class="table table-hover table-condensed table-striped">
                    ...
                    <tr >
                        ...
                        <td>{{$session_name}}</td>
                        <td>{{$roll}}</td>
                        <td style='text-align: center'><button type="button" data-title="Fees collection " data-studentid="{{ $student_id }}" data-schoolid="{{ $school_id }}" data-classid="{{ $class_id }}" class="btn btn-primary paynow" data-toggle="modal" data-target="#modal-xl" data-url="{{ route('school_accounts_panel-fees_collection.payment') }}"  style="background-color:green;border-color:green ">
